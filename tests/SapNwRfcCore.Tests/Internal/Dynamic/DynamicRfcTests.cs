...
public sealed class DynamicRfcTests
{
    ...
    [InlineData([new byte[] { 1, 2, 3 }, (int)SapRfcType.RFCTYPE_BYTE])]
    [InlineData([new byte[] { 1, 2, 3 }, (int)SapRfcType.RFCTYPE_XSTRING])]
    ...
    public void TryGetRfcValue_Structure()
    {
        ...
        var fieldMetadata = fieldMetadatMock.Object;
