...
internal class RfcInterop
{
    ...
    public static RfcInterop Instance { get; } = new RfcInterop();
    ...
    public virtual RfcResultCode GetFunctionName(IntPtr rfcHandle, out string funcName, out RfcErrorInfo errorInfo)
    {
        ...
        var resultCode = RfcGetFunctionName(rfcHandle, buffer, out errorInfo);
    ...
    {
        var buffer = new StringBuilder(31);
        var resultCode = RfcGetTypeName(rfcHandle, buffer, out errorInfo);
