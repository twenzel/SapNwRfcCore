...
namespace SapNwRfcCore.Pooling;
...
public sealed class SapConnectionPool : ISapConnectionPool
{
    ...
    public void Dispose()
    {
        _leases.Dispose();
        _timer.Dispose();
        while (_idleConnections.TryDequeue(out var idleConnection))
    ...
    public ISapConnection GetConnection(CancellationToken cancellationToken = default)
    {
        ...
        var connection = _connectionFactory(_connectionParameters);
    ...
    public void ReturnConnection(ISapConnection connection)
    {
        ...
        {
            var expiresAtUtc = DateTime.UtcNow + _connectionIdleTimeout;
    ...
    {
        while (_idleConnections.TryPeek(out var idleConnection)
