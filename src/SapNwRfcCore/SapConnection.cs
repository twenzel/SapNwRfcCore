...
public sealed class SapConnection : ISapConnection
{
    ...
    public void Connect()
    {
        var interopParameters = _parameters.ToInterop();
    ...
    private void Disconnect(bool disposing)
    {
        ...
        var resultCode = _interop.CloseConnection(
    ...
    public bool IsValid
    {
        get
        {
            ...
            var resultCode = _interop.IsConnectionHandleValid(_rfcConnectionHandle, out int isValid, out _);
    ...
    {
        var resultCode = _interop.GetConnectionAttributes(
            rfcHandle: _rfcConnectionHandle,
